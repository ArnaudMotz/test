...
external_url "https://soprasteria-gitlab-dev.westeurope.cloudapp.azure.com"

nginx['redirect_http_to_https'] = true

# For GitLab
nginx['ssl_certificate'] = "/etc/gitlab/ssl/soprasteria-gitlab-dev.westeurope.cloudapp.azure.crt"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/soprasteria-gitlab-dev.westeurope.cloudapp.azure.com.key"

## Integration Azure OAuth2
...
gitlab_rails['omniauth_providers'] = [
  {
    "name" => "azure_oauth2",
    "args" => {
      "client_id" => "1f03aeb4-cf29-4fae-825a-443ed69f0c33",
      # "client_id" => "1f03aeb4-cf29-4fae-825a-443ed69f0d12", #client id faux pour test
      "client_secret" => "5UUj+BcYqtwp0TZx6o1K5XNf/L3/1YNEdOgwN9t1Irc=",
      "tenant_id" => "52828018-ed05-48db-b282-5028deb5b8a1",
    }
  }
]
